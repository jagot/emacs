...
* Misc
  [[http://www.gnu.org/software/emacs/manual/html_mono/cl.html][Common Lisp macros for Emacs lisp]]
...
** Linum mode
   #+BEGIN_SRC emacs-lisp
     (use-package linum
       :init
       (progn
         (defcustom linum-disabled-modes-list '(eshell-mode wl-summary-mode compilation-mode org-mode image-mode dired-mode)
