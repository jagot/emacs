...
** Org preview LaTeX
   ...
   #+BEGIN_SRC emacs-lisp
     (bind-key "C-x p" 'org-preview-latex-fragment)
     (bind-key "C-x P" 'org-ctrl-c-ctrl-c)
...
** Helm Bibtex
  ...
  #+END_SRC
** Doi2Bibtex
   Borrowed from [[http://blog.anghyflawn.net/2014/04/22/emacs-give-a-doi-get-a-bibtex-entry/][Pavel Iosad]].
   #+BEGIN_SRC emacs-lisp
